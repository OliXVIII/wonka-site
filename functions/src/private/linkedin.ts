export const linkedinSecretPrompt = (
  ...
  return {
    system: `Your task is to generate a great LinkedIn post for the following content:
  "
  ${content.replace(/"/g, "'")}
  ".
  
Requirements for a great LinkedIn post:
- Should begin with a hook, like a question or a statement that grabs the reader's attention.
...
- Should include relevant hashtags and mentions to increase visibility.
...
- Output the completed HTML content only, no further explanation.`,
    ...
    user: `Generate a great LinkedIn post in html with geniuine interest in helping the reader, concise and to the point.
