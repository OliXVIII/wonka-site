  ...
  return (
    <div>
      <label
        htmlFor={`${name}-upload`}
        className={cn(
          "group relative mt-2 flex cursor-pointer flex-col items-center justify-center rounded-md border border-gray-300 bg-light shadow-sm transition-all hover:bg-gray-50",
          aspectRatio,
          {
