...
export default function DeleteSiteForm({ siteName }: { siteName: string }) {
  ...
  return (
    <form
      ...
      className="rounded-lg border border-red-600 bg-light dark:bg-black"
    >
    ...
    <button
      className={cn(
        ...
        pending
          ...
          : "border-red-600 bg-red-600 text-light hover:bg-light hover:text-red-600 dark:hover:bg-transparent",
      )}
      disabled={pending}
    >
