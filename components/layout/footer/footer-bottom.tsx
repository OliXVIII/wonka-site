...
export default function FooterBottom(uiContent: UiContent) {
  ...
  return (
    <div className="mt-5 border-t border-neutral-300 py-10 text-sm dark:border-neutral-700">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-1 px-4 md:flex-row md:gap-0 md:px-4 min-[1320px]:px-0">
        <p>{copyrightName}</p>
        <hr className="mx-4 hidden h-4 w-[1px] border-l border-neutral-300 md:inline-block" />
